  ...
  handleClick = (link) => {
    Linking.canOpenURL(link).then((supported) => {
      if (supported) {
        ...
        console.log('I don\'t know how to open the URI: '+link);
      }
    });
  }
        ...
        <View style={[theme.cardStyle, styles.card]}>
          ...
          <View style={styles.actionArea}>
            <TouchableOpacity
              ...
              <Image resizeMode={'cover'} source={require('../images/call2x.png')} style={styles.actionImage} />
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => this.handleClick(`sms:${this.props.person.phone}`)}>
              <Image resizeMode={'cover'} source={require('../images/email2x.png')} style={styles.actionImage} />
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => this.handleClick(`mailto:${this.props.person.email}`)}>
              <Image resizeMode={'cover'} source={require('../images/sms2x.png')} style={styles.actionImage} />
            </TouchableOpacity>
          </View>
          <View style={styles.actionArea}>
            <Text>Call</Text>
